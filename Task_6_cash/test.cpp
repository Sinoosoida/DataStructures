...
//
//int main() {
//    auto fetchFunction = [](const std::string &key) -> std::string {
//        std::cout << "Fetching data from server for key: " << key << std::endl;
//        return "Value for key " + key;
//    };
//    LRUCache<std::string, std::string> cache(2, fetchFunction);
//
//
//    std::cout << ((*(cache.get("key1")))==fetchFunction("key1")) << std::endl;// should print "value1"
//    std::cout << *(cache.get("key2")) << std::endl;// should print "value2"
//    std::cout << *(cache.get("key1")) << std::endl;// should print "value2"
//    std::cout << *(cache.get("key3")) << std::endl;// should print "value2"
//    std::cout << *(cache.get("key1")) << std::endl;// should print "value2"
//    std::cout << *(cache.get("key2")) << std::endl;// should print "value2"
//}
